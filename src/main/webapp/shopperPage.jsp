            ...
            <nav class="navbar navbar-full navbar-fixed-top bg-inverse">
                ...
                <div class="collapse navbar-toggleable-sm" id="tmNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="#tm-section-2" class="nav-link">Find Deals</a>
                        </li>
                        <li class="nav-item">
                            <a href="#tm-section-3" class="nav-link">Your Shopping Lists</a>
                        </li>
                        <li class="nav-item">
                            <a href="#tm-section-4" class="nav-link">Your Account</a>
                        </li>
						<li class="nav-item">
